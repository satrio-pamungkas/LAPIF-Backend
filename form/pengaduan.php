...
<head>
    ...
    <title>Layanan Pengaduan - LAPIF</title>
...
<body>
    <div class="container-fluid p-0">
        ...
        <section id="banner-1-asp-pengaduan">
            <div class="banner-1-bgshadow-asp-pengaduan">
                ...
                <div class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <div class="text-header m-asp-pengaduan-custom">
                            <p class="title-asp-pgd">Layanan Pengaduan</p>
                            <p class="description-asp-pgd">Kirim pengaduan Anda melalui formulir berikut</p>
                        </div>
                    </div>
                </div>
                <!-- end of header -->
                ...
                <!-- new form -->
                <div class="container new-form p-3 shadow-lg rounded mb-5 bg-light" style="margin-top: 200px;">
                    <form action="../process/form-process.php" class="row p-3" method="POST">
                        <div class="col-12">
                        ...
                        <div class="col-md-6 mt-5 mb-5">
                            <button type="submit" class="btn btn-primary float-end" name="laporan">Kirim</button>
                        </div>
                    </form>
                </div>
                <!-- end of new form -->
    ...
    <script src="script/script-pelaporan.js"></script>
</body>
